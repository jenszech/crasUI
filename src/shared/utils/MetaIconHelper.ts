import * as Awesome from '@fortawesome/fontawesome-svg-core';
import {
  faAppleAlt,
  faCheckSquare,
  faTv,
...
export default class MetaIconHelper {
  public static getIconClass(icon: AusstattungType): Awesome.IconName {
    switch (icon) {
